...
public class MainActivity extends AppCompatActivity {
    ...
    private void callnewActivityForsqlLite() {
    ...
    private void loginResult(){
        ...
        Log.e(mTAG,"hgbdddhjhvcfdjfvjdfvcjdfvc="+userName);
        Log.e(mTAG,"hgbdddhjhvcfdjfvjdfvcjdfvc="+password);
